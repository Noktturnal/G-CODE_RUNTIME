...
from .views import home_view, project_list_view, task_list_view, task_detail_view, user_profile_view, create_task_view, delete_analysis_result_view
...
urlpatterns = [
    ...
    path('analysis_result/<int:result_id>/delete/', delete_analysis_result_view, name='delete_analysis_result'),
]